...
const roughTiles = () => {
  ...
  return (
    <div  className='w-full min-h-screen bg-gray-400 pb-[5vw] pt-3 text-gray-100  px-[8vw] rounded-tl-3xl rounded-tr-3xl'>
      ...
      <div className="container rounded-3xl shadow-xl lg:grid-cols-3  p-2 bg-gray-500 grid-flow-row-dense grid gap-2 w-full min-h-[230vw] sm:min-h-[100vw] md:min-h-[90vw] lg:min-h-[60vw] xl:min-h-[50vw]">
        ...
        <div className="group lg:col-span-2 rounded-3xl relative gap-2 overflow-hidden flex-col flex items-center justify-center bg-gray-200 min-h-[50px] col-span-2 row-span-2">
          ...
          <motion.h1 initial={{x:0}} animate={{x:"-100%"}} transition={{ease:"linear",repeat:Infinity,duration:20}} className='flex gap-3'>
            <div className='h-full lg:w-[300px] xl:w-[400px] sm:w-[290px] w-[390px]'><img className='w-full h-full object-cover rounded-xl' src="fin6.png" alt="" /></div>
            <div className='h-full lg:w-[300px] xl:w-[400px] sm:w-[290px] w-[390px]'><img className='w-full h-full object-cover rounded-xl' src="fin5.png" alt="" /></div>
            <div className='h-full lg:w-[300px] xl:w-[400px] sm:w-[290px] w-[390px]'><img className='w-full h-full object-cover rounded-xl' src="amazzon.png" alt="" /></div>
            <div className='h-full lg:w-[300px] xl:w-[400px] sm:w-[290px] w-[390px]'><img className='w-full h-full object-cover rounded-xl' src="samsung.png" alt="" /></div>
            <div className='h-full lg:w-[300px] xl:w-[400px] sm:w-[290px] w-[390px]'><img className='w-full h-full object-cover rounded-xl' src="mv.png" alt="" /></div>
          </motion.h1>
          <motion.h1 initial={{x:0}} animate={{x:"-100%"}} transition={{ease:"linear",repeat:Infinity,duration:20}} className='flex gap-3'>
            <div className='h-full lg:w-[300px] xl:w-[400px] sm:w-[290px] w-[390px]'><img className='w-full h-full object-cover rounded-xl' src="fin6.png" alt="" /></div>
            <div className='h-full lg:w-[300px] xl:w-[400px] sm:w-[290px] w-[390px]'><img className='w-full h-full object-cover rounded-xl' src="fin5.png" alt="" /></div>
