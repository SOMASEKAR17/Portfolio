...
const marquee = () => {
  return (
    <div data-scroll data-scroll-section data-scroll-speed='.1' className='w-full lg:pt-20 lg:pb-40 py-20 -mb-5 -mt-33 sm:-mt-30 rounded-tl-3xl rounded-tr-3xl bg-zinc-600'>
